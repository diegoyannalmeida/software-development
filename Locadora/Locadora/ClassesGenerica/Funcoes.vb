...
Namespace ClassesGenerica
    Public Class Funcoes
        ...
        'Criar uma funcao para o PreencheEstadoCivil 
        ...
        Public Function Formatar(ByVal obj As Object, ByVal tipoFormato As TipoFormato, Optional ByVal tipo As String = "N", Optional ByVal keyValue As Integer = 0) As String
            ...
            Try
                If TypeOf obj Is TextBox Then
                    ...
                    If CType(obj, TextBox).MaxLength = 14 And (TipoFormato.Cpf) Then

                        Dim cpf = LimpaFormatacao(CType(obj, TextBox).Text.ToString)

                        If cpf.Length > 11 Then
                            cpf = Mid(cpf, 1, 11)
                            CType(obj, TextBox).Text = cpf
                        End If
        ...
        Public Function BuscaIndex(ByRef combo As ComboBox, Optional ByVal codigo As Integer = 0, Optional ByVal texto As String = "") As Integer

            Try

                Dim inicio = 0

                If combo.Items.Count = 0 Then Return -1
                If combo.Items(0).ToString() = "" Then
                    inicio = 1
                End If

                If codigo > 0 Then

                    For i As Short = inicio To combo.Items.Count - 1

                        Dim item = CType(combo.Items(i), Item)
                ...
                Else
                    ...
                    For i As Short = inicio To combo.Items.Count - 1
                        ...
                        If item.Texto.ToUpper() = texto.ToUpper() Then
                            Return i
                        End If
    ...
    'Public Sub PreencheCombo(ByVal Tabela As String, ByVal Campo As String, ByVal Chave As String, ByVal Obj As ComboBox, Optional ByVal Codigo As Double = 0, Optional ByVal Branco As String = "S", Optional ByVal Clausula As String = "", Optional ByVal RESTRICAO_EMPRESA As String = "N", Optional ByVal Formata_6_Casas As Boolean = False, Optional ByVal CampoEmpCodigo As String = "EMP_CODIGO", Optional ByVal GroupBy As String = "", Optional ByVal Ordenar As String = "")
    '    Dim ObjItem As New Cls_Item()
    '    Dim Array(,) As String

    '    Try

    '        Array = Mdi_DDSTMS.conMySQL.PreencheArray(Tabela, Campo, Chave, Clausula, Formata_6_Casas, CampoEmpCodigo, GroupBy, Ordenar)

    '        Obj.Items.Clear()

    '        If UCase(Branco) = "S" Then
    '            Obj.Items.Add("")
    '        End If

    '        For I As Double = 0 To (Array.Length / 4) - 1
    '            ObjItem = New Cls_Item(Val(Array(I, 0)), Val(Array(I, 1)), Array(I, 2))
    '            Obj.Items.Add(ObjItem)
    '        Next I

    '        If Codigo > -1 Then
    '            Obj.SelectedIndex = BuscaIndex(Obj, , Codigo)
    '        End If

    '    Catch ex As Exception
    '        Call ErroCritico(Err.Number, Err.Description, "PreencheCombo", "Cls_Functions")
    '    End Try
    'End Sub
